...
class Recommendation:
    def __init__(self, user_clothes):
        ...
        if self.sex == 'F':
            ...
            self.categories = {'campus': np.array([1, 0, 0, 0, 0, 0, 0, 0]),
                               'casual': np.array([0, 1, 0, 0, 0, 0, 0, 0]),
            ...
            self.categories = {'campus': np.array([1, 0, 0, 0, 0, 0]),
                               'casual': np.array([0, 1, 0, 0, 0, 0]),
                               'modern': np.array([0, 0, 1, 0, 0, 0]),
                               'office': np.array([0, 0, 0, 1, 0, 0]),
    ...
    def result_similarity(self):
        ...
        for i in self.clothes.keys():
            ...
            if self.sex == 'W':
                ...
                self.clothes[i] = self.clothes[i].drop(self.clothes[i].index[:7])
                self.clothes[i] = self.clothes[i].T.sort_values(by=[7], ascending=False)
            if 'outer' in i:
